...
\begin{figure}[H]
	...
	\begin{tabular}{ccccc}
		...
		\bottomrule
	\end{tabular}
	\captionof{table}{Experiment 1 - HMM model}
...
\begin{figure}[H]
	...
	\begin{tabular}{cccc}
		...
		\bottomrule
	\end{tabular}
	\captionof{table}{Experiment 3 - HMM model}
	\label{tab:error_model3}
\end{figure}

In the two tables that follow are shown the results obtained from the evaluation of the \textit{local correction} 
