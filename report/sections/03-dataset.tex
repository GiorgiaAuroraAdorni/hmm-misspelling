...
\begin{enumerate}
	...
	relation $x \sim \text{Bin}(n, p)$ \textbf{FIXME}:{Explain the assumption}... We assume that, in our artificial 
	perturbation of words, the number of errors in a word follows a binomial distribution depending on the length 
	of the word. 
